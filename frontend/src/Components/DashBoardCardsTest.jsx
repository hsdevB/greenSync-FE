...
const DashBoardCardsTest = ({ unityContext }) => {
  ...
  return (
    <div className="dashboard-test-grid-layout">
      {/* Unity 섹션 - 왼쪽 고정 */}
      <div className="unity-section-test">
        <div className="unity-content-test">
          <div className="unity-placeholder">
            <div className="unity-placeholder-text">
              Unity WebGL 영역
            </div>
            <div className="unity-placeholder-desc">
              여기에 Unity 3D 화면이 표시됩니다
            </div>
          </div>
        </div>
      </div>
      ...
      {/* UI 섹션 - 오른쪽 스크롤 */}
      <div className="ui-section-test">
        <div className="ui-header-test">
          <div className="dashboard-title">대시보드 테스트</div>
          <div className="dashboard-time">{getCurrentTimeString()}</div>
        </div>
        <div className="ui-content-test">
...
export default DashBoardCardsTest;